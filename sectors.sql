...
--
-- Host: db
-- Generation Time: May 19, 2022 at 05:12 PM
...
INSERT INTO `category_group` (`id`, `category_group_name`, `category_group_id`, `category_group_item_id`) VALUES
(1, 'Bakery & confectionery products', 1, NULL),
(2, 'Beverages', 1, NULL),
(3, 'Fish & fish products', 1, NULL),
(4, 'Meat & meat products', 1, NULL),
(5, 'Milk & dairy products', 1, NULL),
(6, 'Other', 1, NULL),
(7, 'Sweets & snack food', 1, NULL),
(8, 'Bathroom/sauna', 2, NULL),
(9, 'Bedroom', 2, NULL),
(10, 'Children\'s room', 2, NULL),
(11, 'Kitchen', 2, NULL),
(12, 'Living room', 2, NULL),
(13, 'Office', 2, NULL),
(14, 'Other (Furniture)', 2, NULL),
(15, 'Outdoor', 2, NULL),
(16, 'Project furniture', 2, NULL),
(17, 'Machinery components', 3, NULL),
(18, 'Machinery equipment/tools', 3, NULL),
(19, 'Manufacture of machinery', 3, NULL),
(20, 'Maritime', 3, 1),
(21, 'Metal structures', 3, NULL),
(22, 'Other', 3, NULL),
(23, 'Repair and maintenance service', 3, NULL),
(24, 'Construction of metal structures', 4, NULL),
(25, 'Houses and buildings', 4, NULL),
(26, 'Metal products', 4, NULL),
(27, 'Metal works', 4, 2),
(28, 'Packaging', 5, NULL),
(29, 'Plastic goods', 5, NULL),
(30, 'Plastic processing technology', 5, 3),
(31, 'Plastic profiles', 5, NULL),
(32, 'Advertising', 6, NULL),
(33, 'Book/Periodicals printing', 6, NULL),
(34, 'Labelling and packaging printing', 6, NULL),
(35, 'Clothing', 7, NULL),
(36, 'Textile', 7, NULL),
(37, 'Other (Wood)', 8, NULL),
(38, 'Wooden building materials', 8, NULL),
(39, 'Wooden houses', 8, NULL),
(40, 'Data processing, Web portals, E-marketing', 9, NULL),
(41, 'Programming, Consultancy', 9, NULL),
(42, 'Software, Hardware', 9, NULL),
(43, 'Telecommunications', 9, NULL),
(44, 'Air', 10, NULL),
(45, 'Rail', 10, NULL),
(46, 'Road', 10, NULL),
(47, 'Water', 10, NULL);
...
INSERT INTO `category_group_item` (`id`, `group_item_name`, `group_item_id`) VALUES
(1, 'Aluminium and steel workboats', 1),
(2, 'Boat/Yacht building', 1),
(3, 'Ship repair and conversion', 1),
(4, 'CNC-machining', 2),
(5, 'Forgings, Fasteners', 2),
(6, 'Gas, Plasma, Laser cutting', 2),
(7, 'MIG, TIG, Aluminum welding', 2),
(8, 'Blowing', 3),
(9, 'Moulding', 3),
(10, 'Plastic welding and processing', 3);
...
(1, 'test', 3, '2022-05-17 15:26:27'),
(11, 'MYSQL_USER', NULL, '2022-05-17 15:55:38'),
(13, 'tere1', NULL, '2022-05-18 15:18:46'),
(14, 'tere2', NULL, '2022-05-18 15:19:59'),
(15, 'tere3', NULL, '2022-05-18 15:20:01'),
(16, 'tere4', NULL, '2022-05-18 15:20:06'),
(17, 'tere51', NULL, '2022-05-18 15:21:20'),
(18, 'tere12', NULL, '2022-05-18 15:23:01'),
(19, '6666', NULL, '2022-05-18 15:23:20'),
(20, 'mm', NULL, '2022-05-18 15:24:57'),
(21, 'aaa', NULL, '2022-05-18 15:26:19'),
(22, 'a', NULL, '2022-05-18 15:26:33'),
(23, '1', NULL, '2022-05-18 15:26:53');
...
CREATE TABLE `user_category_preference` (
  ...
  `category_class_id` int NOT NULL,
  `category_group_id` int NOT NULL,
  `category_group_item_id` int NOT NULL,
  `date_created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
INSERT INTO `user_category_preference` (`id`, `category_id`, `category_class_id`, `category_group_id`, `category_group_item_id`, `date_created`) VALUES
(1, 1, 0, 0, 0, '2022-05-19 15:06:38'),
(2, 1, 0, 0, 0, '2022-05-19 15:07:19'),
(3, 1, 0, 0, 0, '2022-05-19 15:07:21');
